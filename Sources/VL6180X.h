...
#define VL_MULTIPLE_DEVICES  2  /* set to greater zero with the number of devices */
...
static uint8_t Measure_TOFCE1(void);
static uint8_t Measure_TOFCE2(void);
static uint8_t Measure_TOFCE3(void);
static uint8_t Measure_TOFCE4(void);
